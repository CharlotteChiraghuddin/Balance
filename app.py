...
from insight_engine import (
    analyze_exercise, analyze_finance, calculate_total_calories,
    analyze_mood, generate_calorie_insights, generate_exercise_insights,
    generate_finance_insights, generate_mood_insights, analyze_calories,
    generate_calorie_insights
)
...
# Updated: Repository now takes no arguments
repo = Repository()
...
def home():
    ...
    return render_template(
        ...
        calorie_insights=calorie_insights
    )
...
def insights():
    ...
    return render_template(
        "insights.html",
        full_data_day=full_data_day,
        full_data_week=full_data_week,
